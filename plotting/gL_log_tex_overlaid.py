...
matches = []
for root, dirnames, filenames in os.walk('../gL_log'):
...
with open('../tex_files/gL_log_overlaid.tex','w') as main_file:
        ...
        for path_file in matches:
            ...
            if(prev_lam != lambdas):
                ...
                with open('../tex_files/begin.tex','r') as begin:
                    ...
                    with open('../tex_files/body_log_overlaid.tex', 'r') as body:
                        for line in body:
                            main_file.write(line) 
